...
<Modal on:close={() => {$modalShown = false}}>
    ...
    <div slot="default">
		...
		>
			<span>Your quote is a small piece of text that will be displayed publically on your profile.</span><br /><br />
            <input type="text" class="modal-input white" placeholder="Write something..." maxlength="360" bind:value={$user.quote} /><br /><br />
